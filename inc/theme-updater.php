...
class HMS_Maverick_Updater {
	...
	public function set_theme_properties() {
		...
		// Replacing with  wp_get_theme( string $stylesheet = null, string $theme_root = null )
		$this->theme	= wp_get_theme( $this->file );

		// Replacing with wp_basename
		$this->basename = wp_basename( $this->file );

		// wp_get_theme()
		$this->active	= wp_get_theme( $this->basename );
	}
	...
	public function after_install( $response, $hook_extra, $result ) {
		...
		$install_directory = get_stylesheet_directory( $this->file ); // Our theme directory
